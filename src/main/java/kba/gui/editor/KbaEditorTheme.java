...
public class KbaEditorTheme extends Theme {
    ...
    private static final Definition SELECTED = new Definition(Color.YELLOW, Color.RED, true);
	...
	public KbaEditorTheme() {
        ...
        setDefinition(Category.BUTTON_LABEL_ACTIVE, new Definition(Color.YELLOW, Color.RED, true));
        ...
        setDefinition(Category.TEXTBOX_FOCUSED, new Definition(Color.YELLOW, Color.RED, true));
